...
WHERE
    ...
    eaf.fcy_nm IN ('Bay', 'Caro', 'Central', 'Flint', 'Karmanos', 'Lansing', 'Lapeer', 'Macomb', 'Northern', 'Oakland', 'Port Huron', 'St. Lukes', 'Thumb')
)
...
WHERE
    COALESCE(eaf.excld_trnsfr_encntr_ind,0) = 0
)
DISTRIBUTE ON (fcy_nm, encntr_num);
...
SELECT
    ...
    CASE
        ...
        WHEN eaf_cf.iptnt_encntr_type = 'Boarder Baby' THEN 'INF004'
    ...
    CASE
        ...
        WHEN eaf_cf.iptnt_encntr_type = 'Boarder Baby' THEN 'IP Patient Days-Boarder Baby'
...
WHERE
    ...
    eaf_cf.calculated_or_hrs IS NOT NULL AND
